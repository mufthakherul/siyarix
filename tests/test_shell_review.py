...
class TestReviewAndConfirm:
    ...
    @patch("siyarix.shell_review.review_command")
    def test_edit_returns_edited(self, mock_review: MagicMock) -> None:
    ...
    @patch("siyarix.shell_review.review_command")
    def test_run_returns_original(self, mock_review: MagicMock) -> None:
        mock_review.return_value = ReviewResult(
    ...
    @patch("siyarix.shell_review.review_command")
    def test_step_returns_original(self, mock_review: MagicMock) -> None:
        mock_review.return_value = ReviewResult(
