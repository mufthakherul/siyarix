"""Manage reusable command profiles / templates for Phalanx."""
...
def _config_dir() -> Path:
    override = os.getenv("PHALANX_CONFIG_DIR")
    return Path(override).expanduser() if override else Path.home() / ".phalanx"
