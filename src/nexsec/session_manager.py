...
Usage::
    ...
    from nexsec.session_manager import command_history, session_registry
...
_NEXSEC_DIR = Path(os.getenv("NEXSEC_CONFIG_DIR", str(Path.home() / ".nexsec")))
...
class CommandHistory:
    ...
    def __init__(self, db_path: Path | None = None) -> None:
        self._db_path = db_path or (_NEXSEC_DIR / "command_history.db")
...
class SessionRegistry:
    ...
    def __init__(self, db_path: Path | None = None) -> None:
        self._db_path = db_path or (_NEXSEC_DIR / "sessions.db")
        self._db_path.parent.mkdir(parents=True, exist_ok=True)
        self._init_db()
