...
I want developers to build on top of Siyarix! So, third-party plugins loaded via `~/.siyarix/plugins/` are **exempt** from AGPL requirements and can use any license you want. Check out the [Plugin Exception](legal-plugin-exception) document for details.
...
- Read our [NOTICE File Explained](legal-notice-file-explained).
- Review the [Disclaimer](legal-disclaimer).
