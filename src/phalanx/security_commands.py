"""Phalanx CLI — Security Operations Commands.
...
def list_incidents(
    ...
    Examples:
      phalanx security incidents
      phalanx security incidents --severity critical --limit 5
      phalanx security incidents --status open --output json
    """
...
def create_incident(
    ...
    Example:
      phalanx security incident-create --title "SQLi on login page" --description "Blind SQL injection" --category intrusion --severity high
    """
    sev_colors = {
        "critical": "red",
        "high": "orange1",
