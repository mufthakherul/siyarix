...
class TestNode:
    def test_to_dict(self):
        node = Node(node_id="n1", node_type=NodeType.HOST, label="10.0.0.1",
...
class TestEdge:
    def test_to_dict(self):
        edge = Edge(source_id="n1", target_id="n2", edge_type=EdgeType.HAS_PORT,
                     properties={"port": 80})
        d = edge.to_dict()
        assert d["source"] == "n1"
        assert d["target"] == "n2"
...
class TestNodeOps:
    ...
    def test_add_node_dedup(self, kg):
        ...
        n1 = kg.add_node(NodeType.HOST, "a", node_id="a")
        _n2 = kg.add_node(NodeType.HOST, "10.0.0.1", extra="merged")
        assert n1 is n2
        assert n2.properties["extra"] == "merged"
        assert kg.node_count == 1
    ...
    def test_remove_node(self, kg):
        ...
        assert kg.remove_node(n1.node_id) is True
        assert kg.get_node(n1.node_id) is None
...
class TestEdgeOps:
    def test_add_edge(self, kg):
        ...
        edge = kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
    ...
    def test_add_edge_dedup(self, kg):
        _n1 = kg.add_node(NodeType.HOST, "h1")
        n1 = kg.add_node(NodeType.HOST, "a", node_id="a")
        _n2 = kg.add_node(NodeType.PORT, "h1:80")
        e1 = kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
        e2 = kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT, extra="prop")
        assert e1 is e2
    ...
    def test_get_edges(self, kg):
        _n1 = kg.add_node(NodeType.HOST, "h1")
        _n2 = kg.add_node(NodeType.PORT, "p1")
        n1 = kg.add_node(NodeType.HOST, "a", node_id="a")
        n2 = kg.add_node(NodeType.HOST, "b", node_id="b")
        _n3 = kg.add_node(NodeType.PORT, "p2")
        kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
        kg.add_edge(n1.node_id, n3.node_id, EdgeType.HAS_PORT)
        assert len(kg.get_edges(source_id=n1.node_id)) == 2
    ...
    def test_get_edges_by_target(self, kg):
        ...
        _n2 = kg.add_node(NodeType.PORT, "p1")
        kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
        assert len(kg.get_edges(target_id=n2.node_id)) == 1
...
class TestTraversal:
    def test_neighbors_out(self, kg):
        ...
        _n2 = kg.add_node(NodeType.PORT, "p1")
        kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
        neighbors = kg.neighbors(n1.node_id, direction="out")
    ...
    def test_neighbors_in(self, kg):
        ...
        _n2 = kg.add_node(NodeType.PORT, "p1")
        kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
        neighbors = kg.neighbors(n2.node_id, direction="in")
        assert len(neighbors) == 1
    ...
    def test_neighbors_both(self, kg):
        ...
        _n2 = kg.add_node(NodeType.PORT, "p1")
        kg.add_edge(n1.node_id, n2.node_id, EdgeType.HAS_PORT)
        neighbors = kg.neighbors(n2.node_id, direction="both")
        assert len(neighbors) == 1
...
class TestSubgraph:
    def test_subgraph(self, kg):
        _h1 = kg.add_node(NodeType.HOST, "h1", node_id="h1")
        _p1 = kg.add_node(NodeType.PORT, "p1", node_id="p1")
        _v1 = kg.add_node(NodeType.VULNERABILITY, "v1", node_id="v1")
        kg.add_edge("h1", "p1", EdgeType.HAS_PORT)
        kg.add_edge("h1", "v1", EdgeType.HAS_VULN)
...
class TestStats:
    ...
    def test_stats_with_data(self, kg):
        _h1 = kg.add_node(NodeType.HOST, "h1")
        h1 = kg.add_node(NodeType.HOST, "h1", node_id="h1")
        _p1 = kg.add_node(NodeType.PORT, "p1")
        kg.add_edge(h1.node_id, p1.node_id, EdgeType.HAS_PORT)
        s = kg.stats()
