...
def check_plan(
    goal: str, expected_tools: list[str], min_steps: int = 1, max_steps: int | None = None
) -> bool:
    p = RegistryPlanner()
...
def run_tests():
    ...
    tests = [
        ...
        (
            "open source recon on example.com",
            ["whois", "dig", "dig", "curl", "subfinder", "amass", "whatweb"],
            7,
            7,
        ),
        ...
        (
            "aws metadata check on http://169.254.169.254",
        ...
        (
            "gcp metadata check on metadata.google.internal",
            ["curl", "whatweb", "dig", "openssl"],
            4,
            4,
        ),
        ...
        (
            "web app scan on https://example.com",
        ...
        (
            "subdomain enum and web screenshot on example.com",
            ["nmap", "whatweb", "gobuster", "subfinder", "amass", "nuclei"],
            6,
            6,
        ),
        ...
        (
            "passive recon and dns enum on example.com",
            ["nmap", "whatweb", "gobuster", "subfinder", "amass", "nuclei"],
            6,
            6,
        ),
        (
            "network scan and service detection on 10.0.0.1",
            ["nmap", "nmap", "dig", "whois", "masscan"],
            5,
            5,
        ),
        (
            "web audit and directory enum on https://example.com",
            ["curl", "whatweb", "nuclei", "ffuf", "wpscan", "nikto"],
            6,
            6,
        ),
        ...
        (
            "cloud audit and cdn check on https://example.com",
            ["curl", "whatweb", "dig", "openssl"],
            4,
            4,
        ),
        ...
        (
            "port scan on 10.0.0.1 ports 80,443,8080",
            ["nmap", "nmap", "dig", "whois", "masscan"],
            5,
            5,
        ),
        (
            "dns enumeration on example.com with verbose output",
        ...
        (
            "detailed ssl audit on https://example.com with cipher enum",
            ["openssl", "nmap", "nmap"],
            3,
            3,
        ),
        (
            "full port scan with service version on 10.0.0.1",
            ["nmap", "nmap", "dig", "whois", "masscan"],
            5,
            5,
        ),
