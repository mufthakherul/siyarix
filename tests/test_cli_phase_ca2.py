...
class TestOutputFormatter:
    ...
    def test_set_formatter(self):
        from siyarix_agent.output import get_formatter, set_formatter
    ...
    def test_exit_codes_exported(self):
        from siyarix_agent.output import EXIT_AUTH_ERROR, EXIT_ERROR, EXIT_OK
...
class TestSettingsStore:
    def _make_store(self, tmp_path: Path):
        from siyarix_agent.config import SettingsStore
...
class TestProgressRunner:
    def test_run_tools_with_progress_returns_per_tool_results(self, monkeypatch):
        from siyarix_agent import progress as p
        ...
        monkeypatch.setattr("siyarix_agent.executor.run_tool_complete", fake_run_tool_complete)
