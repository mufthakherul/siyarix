...
[bold]Quick Start:[/bold]
  [green]siyarix scan 192.168.1.0/24[/green]        — Quick Nmap scan
  [green]siyarix threat-hunt run q_001[/green] — Run threat hunt
  [green]siyarix incidents list[/green]        — List open incidents
  [green]siyarix run "scan my network"[/green] — Autonomous command mode
...
[bold]Premium Features:[/bold]
  ...
  • [magenta]siyarix bulk[/magenta]          — Bulk operations
  • [magenta]siyarix watch[/magenta]          — Watch mode (live monitoring)
  • [magenta]siyarix workflow[/magenta]      — Workflow orchestration
  • [magenta]siyarix team[/magenta]           — Team & org management
