...
DEFAULTS: dict[str, Any] = {
    ...
    "gemini_model": "gemini-2.5-pro-05-06",
    "gemini_vision_model": "gemini-2.5-pro-05-06",
    "gemini_fast_model": "gemini-2.0-flash",
    "groq_model": "llama-4-scout-17b-16e-instruct",
    "together_model": "meta-llama/Llama-4-Together-17B-16E-Instruct",
    "openrouter_model": "openai/gpt-4.1",
    # New providers
    "deepseek_model": "deepseek-chat",
    "xai_model": "grok-3",
    "mistral_model": "mistral-large-2506",
...
DESCRIPTIONS: dict[str, str] = {
    ...
    "model_provider": "Preferred model provider: auto | openai | gemini | anthropic | groq | together | openrouter | deepseek | xai | mistral | perplexity | azure | ollama | lmstudio",
    "openai_model": "OpenAI model name (default: gpt-4.1)",
    "openai_vision_model": "OpenAI vision-capable model (default: gpt-4.1)",
    "openai_fast_model": "OpenAI fast/cheap model (default: gpt-4.1-mini)",
    "anthropic_model": "Anthropic/Claude model name (default: claude-sonnet-4-20250514)",
    "anthropic_vision_model": "Anthropic vision-capable model (default: claude-sonnet-4-20250514)",
    "gemini_model": "Gemini model name (default: gemini-2.5-pro-05-06)",
    "gemini_vision_model": "Gemini vision-capable model (default: gemini-2.5-pro-05-06)",
    "gemini_fast_model": "Gemini fast model (default: gemini-2.0-flash)",
    "groq_model": "Groq model name (default: llama-4-scout-17b-16e-instruct)",
    "together_model": "Together AI model name (default: meta-llama/Llama-4-Together-17B-16E-Instruct)",
    "openrouter_model": "OpenRouter model name (default: openai/gpt-4.1)",
    "deepseek_model": "DeepSeek model name (default: deepseek-chat)",
    "xai_model": "xAI/Grok model name (default: grok-3)",
    "mistral_model": "Mistral AI model name (default: mistral-large-2506)",
    "perplexity_model": "Perplexity model name (default: sonar-pro)",
    "azure_model": "Azure OpenAI model name (default: gpt-4.1)",
