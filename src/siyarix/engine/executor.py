...
"""Execution engine — unified interface for security tool execution.

Supports three execution modes:
  - Registry mode: direct tool dispatch from the registry.
  - Autonomous mode: model-driven planning and execution.
  - Integrated mode (default): model planning with registry fallback.
"""
        ...
        if interactive:
            with Progress(
                ...
                result = await self._execute_plan(
                    plan, progress, interactive, plan_id, None
                )
        else:
            result = await self._execute_plan(plan, None, interactive, plan_id, None)
