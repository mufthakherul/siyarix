...
echo "    curl -fsSL https://siyarix.dev/apt/KEY.gpg | sudo gpg --dearmor -o /usr/share/keyrings/siyarix.gpg"
echo "    echo 'deb [signed-by=/usr/share/keyrings/siyarix.gpg] https://siyarix.dev/apt stable main' | sudo tee /etc/apt/sources.list.d/siyarix.list"
