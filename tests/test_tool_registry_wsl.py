...
from siyarix_agent.tool_registry import ToolRegistry
...
def test_discover_uses_wsl_fallback_on_windows(monkeypatch):
    ...
    monkeypatch.setattr("siyarix_agent.tool_registry.platform.system", lambda: "Windows")
    monkeypatch.setattr("siyarix_agent.tool_registry.shutil.which", fake_which)
    monkeypatch.setattr("siyarix_agent.tool_registry.subprocess.run", fake_run)
