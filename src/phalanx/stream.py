"""WebSocket streaming client for the Phalanx cloud platform."""
...
class AgentStreamClient:
    """Maintains a WebSocket connection to the Phalanx server.
    ...
    async def connect(self) -> None:
        ...
        while True:
            try:
                ...
                self._backoff = 1.0
                logger.info("Connected to Phalanx server at %s", self._server_url)
