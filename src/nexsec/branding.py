...
_MODES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "key": "[3]",
        "name": "Direct Command",
        "cmd": 'nexsec run "scan target.com"',
        "shortcut": "/3",
    ...
    },
    {
        ...
        "cmd": "nexsec workflow run pentest.yaml",
        "shortcut": "/5",
    ...
    },
    {
        ...
        "cmd": "nexsec team --session ops-room-1",
        "shortcut": "/8",
...
def _sample_command(theme: str) -> str:
    if resolve_theme(theme) == "eclipse":
        return "nexsec scan 10.0.0.5 --mode registry"
    return "nexsec scan 10.0.0.5 --mode integrated"
...
def print_theme_preview(console: Console, theme: str) -> None:
    ...
    table.add_row("Prompt", "nexsec> scan 10.0.0.5")
