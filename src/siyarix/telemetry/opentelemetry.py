...
_trace_id_var: ContextVar[str] = ContextVar("siyarix_trace_id", default="")
_span_id_var: ContextVar[str] = ContextVar("siyarix_span_id", default="")
_span_stack_var: ContextVar[list[str]] = ContextVar("siyarix_span_stack", default=[])
