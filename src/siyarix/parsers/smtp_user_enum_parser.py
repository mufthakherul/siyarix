...
class SmtpUserEnumParser:
    ...
    def parse(self, output: str) -> list[dict]:
        ...
        if _JSON_RE.match(stripped):
            try:
                ...
                for item in items:
                    ...
                    elif user and exists in (False, "false", "False", "not found", "invalid", "rejected"):
                        findings.append({
        ...
        for line in stripped.splitlines():
            ...
            if in_user_list and not any(r.search(line) for r in [_EXISTS_RE, _NOT_EXISTS_RE, _METHOD_RE, _HOST_RE, _PORT_RE, _BANNER_RE, _SMTP_RESPONSE_RE, _VRFY_RE, _EXPN_RE, _RCPT_RE, _USER_BY_NAME_RE, _RESULTS_SUMMARY_RE]):
