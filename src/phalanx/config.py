"""Phalanx CLI — CA-2.4 Configuration Management.

Settings stored in ~/.phalanx/settings.toml — human-editable TOML format.
...
def _write_toml(path: Path, data: dict[str, Any]) -> None:
    ...
    lines = [
        "# Phalanx Agent Settings\n# Edit directly or use: phalanx-agent config set <key> <value>\n"
    ]
...
class SettingsStore:
    """TOML-backed settings manager for the Phalanx CLI.
