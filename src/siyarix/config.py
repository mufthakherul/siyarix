...
DESCRIPTIONS: dict[str, str] = {
    ...
    "model_provider": "Preferred model provider: auto | openai | gemini | ollama | anthropic | groq | together | lmstudio | openrouter",
    ...
    "openrouter_model": "OpenRouter model name (default: nvidia/nemotron-3-super-120b-a12b:free)",
    "agent_timeout": "Max seconds for agent execution (default: 1200 / 20 min)",
